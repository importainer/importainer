  ...
  return (
    <div className="descripcion">
      <div className="left">
        ...
        <div className="cont-right">
          <h3>Cocina:</h3>
          <h4>- Bajo mesada de 1.40m hasta 1.60m.</h4>
          <h4>- Mesada de granito sintético desde 1.40 hasta 1.60m.</h4>
      ...
      <div className="right">
        <div className="cont-right">
          <h3>Equipamiento</h3>
          <p>
            Termotanque eléctrico de {litros} litros.
            <br />
        ...
        <div className="cont-right">
          ...
          <h4>- Ventanas balcón de 2.00 x 2.00m</h4>
          <h4>- Ventana 0.60 x 0.40m para baño</h4>
          <h4>- Ventana de 1.00 x 0.40 hasta 1.50 x 0.40 para cocina</h4>
          <h4>- Puerta de entrada doble chapa o mitad vidrio y mitad aluminio.</h4>
          <p> 
            Opcional: Portón Romano de 2.00 x 2.00m.
          </p>
        </div>
      </div>
    </div>
