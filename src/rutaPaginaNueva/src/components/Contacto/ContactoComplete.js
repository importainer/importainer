...
import contSt from "./ContactoComplete.module.css";
...
const ContactoComplete = () => {
  ...
  return (
    <section className={contSt.contactContainer} id="contacto">
      <h2 className={contSt.contH2} >Contacto</h2>
      <div className={contSt.comp}>
        <div>
          {/* <div className="datos">
